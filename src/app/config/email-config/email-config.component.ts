...
export class EmailConfigComponent implements OnInit {
  ...
  constructor(
    ...
    private _service: EmailConfigService,
  ...
  ngOnInit(): void {
    ...
    this.validateForm = this.fb.group({
          ...
          max_record: [{ value: '', disabled: true }, [Validators.required]],
          port_number: [{ value: '', disabled: true }, [Validators.required]],
          smpt_format: [{ value: '', disabled: true }, [Validators.required]],
