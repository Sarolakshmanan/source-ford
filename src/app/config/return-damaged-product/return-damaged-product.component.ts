...
@Component({
  selector: 'app-return-damaged-product',
  templateUrl: './return-damaged-product.component.html',
  styleUrls: ['./return-damaged-product.component.scss'],
})
export class ReturnDamagedProductComponent implements OnInit {
  //scope
  searchText: any;
  ...
  constructor(
    ...
    private _service: ReturnDamagedProductService,
