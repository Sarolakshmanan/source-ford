...
@Component({
  selector: 'app-product-life-cycle',
  templateUrl: './product-life-cycle.component.html',
  styleUrls: ['./product-life-cycle.component.scss']
})
export class ProductLifeCycleComponent implements OnInit {
  //scope
  searchText: any;
  ...
  constructor(
    ...
    private _service: ProductLifeCycleService,
