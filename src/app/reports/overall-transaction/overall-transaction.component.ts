...
@Component({
  selector: 'app-overall-transaction',
  templateUrl: './overall-transaction.component.html',
  styleUrls: ['./overall-transaction.component.scss']
})
export class OverallTransactionComponent implements OnInit {
  //scope
  searchText: any;
  ...
  constructor(
    ...
    private _service: OverallTransactionService,
